...
export const Descricoes = () => {
    ...
    const textos = [
        ...
        "<b>QuantBot:</b> Na QuantEdu, através do QuantBot, você será capaz de escolher entre uma lista de empresas listadas em bolsa, como a Apple, e simular o retorno que você teria ao aplicar uma estratégia quantitativa baseada em médias móveis! Não somente isso, fornecemos também: o retorno da ação sem a estratégia e um gráfico interativo, onde você pode acompanhar a evolução da sua estratégia versus a evolução da ação ao longo dos dias passados. Note que não é uma recomendação de investimento, apenas fornecemos uma ilustração de como métodos quantitativos podem ser grandes aliados em sua jornada de investimentos."
    ]
